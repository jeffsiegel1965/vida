...
class TestChannelStore(unittest.TestCase):
    ...
    def test_save_and_get(self):
        c = PaymentChannel(
            id="ch_1", party_a="a", party_b="b", capacity_sompi=100_000_000, balance_a=100_000_000, balance_b=0
        )
        self.store.save(c)
    ...
    def test_update(self):
        c = PaymentChannel(
            id="ch_2", party_a="a", party_b="b", capacity_sompi=100_000_000, balance_a=100_000_000, balance_b=0
        )
        self.store.save(c)
    ...
    def test_close(self):
        c = PaymentChannel(
            id="ch_3", party_a="a", party_b="b", capacity_sompi=100_000_000, balance_a=100_000_000, balance_b=0
        )
        self.store.save(c)
    ...
    def test_persistence(self):
        c = PaymentChannel(
            id="ch_4", party_a="a", party_b="b", capacity_sompi=100_000_000, balance_a=100_000_000, balance_b=0
        )
        self.store.save(c)
...
class TestUpdateChannel(unittest.TestCase):
    def setUp(self):
        ...
        self.store = ChannelStore(storage_dir=self.tmp.name)
        c = PaymentChannel(
            id="ch_update", party_a="a", party_b="b", capacity_sompi=100_000_000, balance_a=100_000_000, balance_b=0
        )
        self.store.save(c)
