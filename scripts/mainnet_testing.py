    ...
    def paper_trading_simulation(self):
        ...
        try:
            ...
            if network_info.get("ok"):
                ...
                results["tests"].append({
                    "test": "network_connectivity", 
                    "status": "FAIL",
                    "error": network_info.get("error", "unknown")
                })
        ...
        if test_address:
            ...
            results["tests"].append({
                "test": "address_validation",
                "status": "SKIP",
                "error": "No test address generated"
            })
            ...
            try:
                ...
                if utxo_result.get("ok"):
                    ...
                    results["tests"].append({
                        "test": "utxo_query",
                        "status": "FAIL",
                        "error": utxo_result.get("error", "unknown")
                    })
...
def main():
    ...
    parser.add_argument("--mode", choices=["paper", "dust", "validate"], required=True,
                       help="Testing mode")
    parser.add_argument("--amount", default="0.001", 
                       help="Amount for dust transactions (KAS)")
