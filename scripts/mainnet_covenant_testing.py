...
class MainnetCovenantTester:
    ...
    def test_mainnet_connectivity(self) -> Dict[str, Any]:
        ...
        test_result = {"test_name": "mainnet_connectivity", "start_time": time.time(), "success": False, "details": {}}
    ...
    def test_wallet_balance_query(self) -> Dict[str, Any]:
        ...
        test_result = {"test_name": "wallet_balance_query", "start_time": time.time(), "success": False, "details": {}}
                        ...
                        positions.append(
                            {
                                ...
                                "total_value": coldkey_data["free_tao"]
                                + sum(stake["stake_tao"] for stake in coldkey_data.get("staked", [])),
                            }
                        )
            except Exception as e:
