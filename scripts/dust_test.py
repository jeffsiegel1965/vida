...
def main():
    ...
    parser.add_argument("--wallet-path", required=True, help="Path to Vida wallet JSON file")
    parser.add_argument("--amount", default="0.03", help="Amount to send (KAS, min 0.02, max 0.1)")
